...
export default function ExplorateurIA({
  ...
  }, [at, isAutoWalking, showMobileControls]);
      ...
      <div className="grid min-h-0 flex-1 w-full grid-cols-1 grid-rows-[minmax(0,1fr)] gap-0">
        <div className="relative flex min-h-0 flex-1 flex-col">
          ...
          <div className="relative flex min-h-0 flex-1 flex-col">
            ...
            {blockedStage && (
              <div className="pointer-events-none absolute inset-x-6 top-20 z-30 flex justify-center">
                <div className="pointer-events-auto max-w-md rounded-2xl border border-rose-200 bg-white/95 px-4 py-2 text-center text-xs font-semibold text-rose-700 shadow-lg backdrop-blur">
                  Terminez d'abord {BUILDING_META[blockedStage]?.label ?? "ce quartier"} pour y accéder.
                </div>
              </div>
            )}
            <div
