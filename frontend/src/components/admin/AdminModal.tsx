...
export function AdminModal({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="flex min-h-full items-start justify-center bg-black/40 px-3 py-6 sm:items-center sm:px-4 sm:py-8">
        <div
          className={`w-full ${SIZE_CLASS[size]} max-h-[90vh] overflow-y-auto rounded-2xl border border-white/60 bg-white/95 p-5 shadow-2xl backdrop-blur sm:rounded-3xl sm:p-6`}
          role="dialog"
          aria-modal="true"
